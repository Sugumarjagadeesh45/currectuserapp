...
const styles = StyleSheet.create({
  ...
  productPrice: { fontSize: 18, fontWeight: '700', color: '#4caf50', marginRight: 10 },
  originalPrice: {
    fontSize: 14,
    color: '#999',
  ...
  discount: { fontSize: 12, color: '#e53935', fontWeight: '600' },
...
//       <View style={styles.imageContainer}>
//         <Image
//           source={{ uri: product.images[0] ? `${BASE_URL}${product.images[0]}` : 'https://via.placeholder.com/100' }}
//           style={styles.productImage}
