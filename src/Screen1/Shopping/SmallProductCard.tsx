    ...
    <View style={styles.card}>
      <View style={styles.imageContainer}>
        {product.images && product.images.length > 0 ? (
          ...
          <Image
            key="placeholder"
            source={{ uri: 'https://via.placeholder.com/140x120' }}
            style={styles.image}
          />
        )}
        {product.discount > 0 && (
...
// const BASE_URL = 'https://fullbackend-g3e5.onrender.com'; // Adjust if needed
...
//       <View style={styles.imageContainer}>
//         <Image
//           source={{ uri: product.images[0] ? `${BASE_URL}${product.images[0]}` : 'https://via.placeholder.com/140x120' }}
//           style={styles.image}
//         />
//         {product.discount > 0 && (
//           <View style={styles.discountBadge}>
...
//       </View>
//       <View style={styles.buttonsContainer}>
//         <TouchableOpacity style={[styles.smallButton, styles.buyButton]} onPress={handleBuy}>
//           <Text style={styles.smallButtonText}>Buy</Text>
//         </TouchableOpacity>
//         <TouchableOpacity style={[styles.smallButton, styles.cartButton]} onPress={handleAddToCart}>
//           <Text style={styles.smallButtonText}>Cart</Text>
//         </TouchableOpacity>
//       </View>
//     </View>
