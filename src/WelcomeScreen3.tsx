...
const verifyOTP = useCallback(async () => {
  ...
  try {
    ...
    Alert.alert('Error', error.response?.data?.error || error.message || 'The OTP is invalid or failed to connect to the server.');
  } finally {
    setLoading(false);
  }
...
// // Updated Frontend: src/WelcomeScreen3.tsx
// import React, { useState, useCallback, useRef, useEffect } from 'react';
// import {
//   View,
//   Text,
...
//   /**
//    * Verifies OTP and handles backend verification.
//    */
//   const verifyOTP = useCallback(async () => {
//     if (!code) {
//       Alert.alert('Error', 'Please enter the OTP.');
...
//         await AsyncStorage.removeItem('verificationId');
//         await AsyncStorage.removeItem('phoneNumber');
//         navigation.navigate('Screen1', { isNewUser: true, phone: mobileNumber });
//       } else {
//         throw new Error(response.data.error || 'Backend verification failed');
//       }
//     } catch (error: any) {
